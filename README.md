...
Instale as dependências rigorosas:

Bash
pip install -r requirements.txt
(Opcional) Download dos Pesos Pré-treinados:
...
🔗 Download do Modelo ResNet50 (Google Drive) - 93MB
Coloque o arquivo baixado diretamente na pasta models/.

Comando único de execução do pipeline:
...
(Recomendado) Executar o projeto através do WSL2 (Windows Subsystem for Linux), onde o suporte à GPU para as versões mais recentes do TensorFlow é totalmente nativo.

Fazer o downgrade forçado para a última versão com suporte nativo no Windows clássico, alterando no arquivo de dependências para tensorflow==2.10.0 (exige CUDA Toolkit 11.2 e cuDNN 8.1 instalados na máquina).
